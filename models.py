...
class Student(db.Model, UserMixin):
    ...
    st_skills = db.Column(db.String(500), nullable=False)
...
class RegisterStudent(FlaskForm):
    ...
    st_skills = StringField('Skills', validators=[InputRequired(), Length(min=2, max=500)], render_kw={"placeholder": "Skills"})
